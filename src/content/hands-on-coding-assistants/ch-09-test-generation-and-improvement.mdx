...
One of the most powerful and underused agent workflows is coverage gap analysis. Instead of asking the agent to "write tests," you give it your current coverage report and ask it to **fill the gaps**.
