...
This is exactly why Modules 01 and 03 of this series focus heavily on **custom instructions, AGENTS.md, and MCP integrations**. The tools can be taught your context, but _you_ have to teach them.
