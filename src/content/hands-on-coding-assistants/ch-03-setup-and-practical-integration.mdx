...
This aligns with the public guidance from [VS Code](https://code.visualstudio.com/docs/agents/best-practices), [GitHub Copilot](https://docs.github.com/en/copilot/get-started/best-practices), and [Google Cloud](https://cloud.google.com/blog/topics/developers-practitioners/five-best-practices-for-using-ai-coding-assistants): configure the project, provide context, plan before implementation, and verify the output.
