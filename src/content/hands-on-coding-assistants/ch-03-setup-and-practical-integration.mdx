...
In Ch 4, we'll cover **spec-driven development** — the practice of writing a structured specification before delegating any meaningful task to an agent. In Ch 5, we'll cover **prompt engineering** — how to structure your prompts, manage context, and decompose complex tasks. In Ch 6, we'll build **custom agents and sub-agents** with `.agent.md` profiles that turn your prompt patterns into reusable team knowledge.
