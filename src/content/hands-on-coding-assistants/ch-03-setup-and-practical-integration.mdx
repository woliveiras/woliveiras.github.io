...
In Ch 4, we'll go deeper into custom instructions and `AGENTS.md`, learning how to write instructions that meaningfully change the AI's output quality. In Ch 5, we'll connect real projects and practice the full PDRC cycle for the first time.
