...
In Ch 9, you learned to create custom agents, specialized profiles that focus on specific tasks. Those same profiles are also a security tool. By controlling which **tools** an agent can access, you control what it can do.
