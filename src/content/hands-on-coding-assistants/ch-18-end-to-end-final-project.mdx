...
This is the chapter where everything connects. Across 17 chapters and 5 modules, you've learned the prerequisites and foundations (Module 0), customized agents and built the harness (Module 1), applied the spec-first workflow to daily engineering tasks (Module 2), extended the system with MCP, hooks, and automation (Module 3), and governed it with security controls and measurement (Module 4).
