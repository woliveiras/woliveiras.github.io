...
Documentation is a natural fit for the delegation-review pattern: you delegate the writing to the agent, review for accuracy and completeness, and correct where the agent hallucinated or missed context. Documentation errors are easier to spot than code bugs — you can read a docstring in 10 seconds and know if it's wrong.
