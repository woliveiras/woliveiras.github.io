...
|--------|-------|---------------|
| **Module 00** (Ch 3–4) | Setup, prompt engineering | **Plan** — configuring tools and learning to prompt effectively |
| **Module 01** (Ch 5–8) | Custom agents, AGENTS.md, instructions, skills | **Plan** — teaching the AI your context |
| **Module 02** (Ch 9–12) | Tests, code review, debugging & refactoring, documentation | **Delegate + Review** — effective tasking and output evaluation |
| **Module 03** (Ch 13–14) | MCP integrations, hooks, agent automation | **Delegate** — extending what the AI can access and do |
| **Module 04** (Ch 15–16) | Security, governance, impact measurement | **Review** — systematic verification and risk management |
| **Module 05** (Ch 17) | End-to-end final project | **Correct** — continuous improvement based on data |
