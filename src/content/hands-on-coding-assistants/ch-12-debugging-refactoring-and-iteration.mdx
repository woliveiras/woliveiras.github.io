...
The Out of Scope section of your spec (Ch 4) is your primary defense. The minimal footprint instruction in `copilot-instructions.md` (Ch 8) is your secondary defense. Use both.
...
In Ch 13, we'll shift from correcting code to **documenting** it — AI-assisted code documentation, API docs, commit messages, and PR descriptions. Documentation is where the Delegate and Review phases shine again, because generating docs is high-value, pattern-heavy work that AI handles well and humans review quickly.
