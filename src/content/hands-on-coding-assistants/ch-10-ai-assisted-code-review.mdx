...
One of the most powerful features in Copilot Code Review is the **"Implement suggestion"** button. When Copilot suggests a change in a review comment, you can click this button and Copilot's coding agent will:
...
- Ch 2 — The PDRC mental model (Review as a core phase)
- Ch 6 — Personal custom instructions (instructions that apply to reviews)
- Ch 7 — Repository custom instructions (`.instructions.md` files that shape review feedback)
- Ch 9 — Test generation (testing as the most verifiable form of review)
- Ch 11 — Debugging, refactoring & iteration (the Correct phase that follows review)
