...
Let's look at a real example: the AGENTS.md file for the woliveiras.com blog (the site you're reading this workshop on). It follows the patterns we've discussed:
...
Hands-on Coding Assistants workshop. Includes basic arithmetic
