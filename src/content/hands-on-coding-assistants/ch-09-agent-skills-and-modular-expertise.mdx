...
`context: fork` requires the `github.copilot.chat.skillTool.enabled` VS Code setting. It's marked experimental but stable for production use as of early 2026.
