...
If you have multiple custom agents (Ch 9), compare their performance.
...
In Ch 4, you learned to write specifications before delegating tasks to an agent. Every spec you write has acceptance criteria as a checklist. Those checkboxes are not just instructions — they are your measurement instrument.
