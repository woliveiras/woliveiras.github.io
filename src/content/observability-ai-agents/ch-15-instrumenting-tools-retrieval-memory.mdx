...
| File | What to do |
|---|---|
| `src/agent_observability/tools.py` | Create the instrumented tool wrapper. |
| `src/agent_observability/retrieval.py` | Create the retrieval wrapper. |
| `src/agent_observability/memory.py` | Create the memory wrapper. |
| `src/agent_observability/main.py` | Update the demo to run tool, retrieval, and memory spans together. |
