...
**Next up**: [Ch 15 - Instrumenting Tools, Retrieval, and Memory](/observability-ai-agents/ch-15-instrumenting-tools-retrieval-memory/) adds spans for non-model dependencies while keeping retrieved content and tool results out of telemetry by default.
