...
If you, like me, are new to the AI Agents world, you probably heard about LangChain and LangGraph. The thing is: if you didn't have time before to learn more about these tools, you may be uncertain about what each one is and when to use it.
