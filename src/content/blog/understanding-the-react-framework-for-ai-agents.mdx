...
## Continue Learning AI Agents

**Build on This Foundation:**

- [Introduction to the Reflexion Framework](/posts/introduction-to-the-reflexion-framework/) - Add memory and self-improvement to your agents
- [Exploring Tree of Thoughts (ToT) and Language Agent Tree Search (LATS)](/posts/exploring-tree-of-thoughts-tot-and-language-agent-tree-search-lats/) - Advanced planning strategies
- [The StateAct Pattern for Robust and Long-Running Agents](/posts/the-stateact-pattern-for-robust-and-long-running-agents/) - Build production-ready agents

**Essential Skills:**

- [The Agentic Prompt Blueprint for High-Performance LLM Instructions](/posts/the-agentic-prompt-blueprint-for-high-performance-llm-instructions/) - Write better prompts
