...
Talking about it with my peers, I kept hearing a different story. The developers I know are not "vibing" code. I thought maybe we're working wrongly, as we really don't like this approach. But my friends and I are a bit strange, as we love to code. Giving up control to an agent and not reviewing its output just doesn't feel right.
