...
The trap is that the signals we habitually read as "this is well engineered" are exactly the signals an agent produces most reliably. It is worth separating what we can actually observe from what those observations prove.
