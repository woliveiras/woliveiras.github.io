...
published: true
tags: ["frontend", "monorepos", "nx", "vite", "biome.js", "react", "typescript", "emotion", "web-development"]
---
...
If you want to dive deeper into the concepts behind this tutorial:

- [Introduction to Monorepos: Managing Large-Scale Codebases Efficiently](/posts/introduction-to-monorepos-managing-large-scale-codebases-efficiently/) - Learn the fundamentals
...
- [Dependency Management Challenges in the JavaScript Ecosystem](/posts/dependency-management-challenges-in-the-javascript-ecosystem/) - Why we chose PNPM
- [Migrating from NPM or Yarn to PNPM](/posts/migrating-from-npm-or-yarn-to-pnpm/) - Deep dive into PNPM
